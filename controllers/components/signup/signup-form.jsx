...
export class SignupForAdmin extends React.Component {
    constructor( props ) {
        super( props );
        ...
        this._signupAdmin = this._signupAdmin.bind( this );
    }
    ...
    _handleChange( e ) {
        ...
        } // TODO check username length here
    }
        ...
        return (
            <div className = 'container'>
                ...
                <div className = 'signup-form-wrap'>
                    <a className = 'redirect-form' href = '/signup'><i className = 'fa fa-long-arrow-left' aria-hidden = 'true'></i>Signup as user</a>
                    <form className = { 'signup-form ' + this.state.formIsValide }>
                        ...
                        <button onClick = { this._signupAdmin } className = 'btn btn-primary'>{ this.state.submitButton }</button>
                    </form>
                </div>
            </div>
        );
...
export class SignupForUser extends React.Component {
    constructor( props ) {
        super( props );
    ...
    render() {
        ...
        return (
            <div className = 'container'>
                ...
                <div className = 'signup-form-wrap'>
                    <a className = 'redirect-form' href = '/signup/admin'>Signup as admin<i className = 'fa fa-long-arrow-right' aria-hidden = 'true'></i></a>
                    <form className = { 'signup-form ' + this.state.formIsValide }>
                        <div className = { this.state.displayError } role = 'alert'>{ this.state.errorMessage }</div>
                        <div className = 'form-row'>
                            <div className = 'form-group col'>
